...
<html>
    <head>
        <meta charset="utf-8">
        <title>AMFITEATR: Привязка карты</title>
    ...
    <body>
        ...
        <div style="width: 1406px; height: 750px; background: #2b2b2b; border-radius: 18px; margin-left: auto; margin-right: auto; margin-top: 75px; align-content: center;">
            <div style="width: auto; height: 70px; position: relative; bottom: 50px; text-align: center;">
                <a style="font-size: 48px; font-family: Papa; color: white"><b>Привязанные</b> карты</a>
            </div>
            <img style="position: relative; left: 25%; top: -30px;" src="file/img/card.png">
            <a style="font-size: 48px; font-family: Papa; color: white; position: relative; left: -125px; top: 50px"><b>ЦЕНА:</b> 500 руб</a>
            <a href="login.html" class="input-button" style="position: relative; top: 85px; left: -300px;">Оплатить</a>
        </div>
